  ...
  return (
    <div className="flex items-center gap-3 flex-wrap no-print">
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-50 border border-blue-300 text-blue-700 text-sm hover:bg-blue-100 disabled:opacity-50 transition-colors"
      >
        {shareState === "loading" ? (
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white border border-slate-300 text-slate-700 text-sm hover:bg-slate-100 transition-colors"
      >
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
